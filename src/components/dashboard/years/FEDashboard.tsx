...
export default function FEDashboard() {
    const semester1 = [
        { name: "Engineering Mathematics I", code: "FE101", color: "blue" },
        { name: "Engineering Physics", code: "FE102", color: "purple" },
        { name: "Basic Electrical Engineering", code: "FE103", color: "green" },
        { name: "Engineering Mechanics", code: "FE104", color: "orange" },
    ]

    const semester2 = [
        { name: "Engineering Mathematics II", code: "FE201", color: "blue" },
        { name: "Engineering Chemistry", code: "FE202", color: "purple" },
        { name: "Engineering Graphics", code: "FE203", color: "green" },
        { name: "C Programming", code: "FE204", color: "orange" },
    ]
    ...
    return (
        <div className="space-y-8">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-slate-900">First Year Dashboard</h2>
                <p className="text-slate-500 mt-1">Welcome to your engineering journey!</p>
            </div>
