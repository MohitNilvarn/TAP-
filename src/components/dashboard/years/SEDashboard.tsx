...
export default function SEDashboard() {
    const semester3 = [
        { name: "Data Structures", code: "SE201", color: "blue" },
        { name: "Discrete Mathematics", code: "SE202", color: "purple" },
        { name: "Object Oriented Programming", code: "SE203", color: "green" },
        { name: "Digital Logic Design", code: "SE204", color: "orange" },
    ]

    const semester4 = [
        { name: "Computer Graphics", code: "SE205", color: "blue" },
        { name: "Microprocessors", code: "SE206", color: "purple" },
        { name: "Principles of Programming Languages", code: "SE207", color: "green" },
        { name: "Data Communication", code: "SE208", color: "orange" },
    ]
    ...
    return (
        <div className="space-y-8">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-slate-900">Second Year Dashboard</h2>
                <p className="text-slate-500 mt-1">Deep dive into core computer science concepts.</p>
            </div>
