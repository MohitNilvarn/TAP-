...
export default function BEDashboard() {
    const semester7 = [
        { name: "Radiation & Microwave Theory", code: "BE401", color: "blue" },
        { name: "VLSI Design and Technology", code: "BE402", color: "purple" },
        { name: "Cloud Computing", code: "BE403", color: "green" },
        { name: "Elective - 3", code: "BE404", color: "orange" },
        { name: "Elective - 4", code: "BE405", color: "red" },
    ]

    const semester8 = [
        { name: "Fiber Optic Communication", code: "BE406", color: "blue" },
        { name: "Elective - 5", code: "BE407", color: "purple" },
        { name: "Elective - 6", code: "BE408", color: "green" },
    ]
